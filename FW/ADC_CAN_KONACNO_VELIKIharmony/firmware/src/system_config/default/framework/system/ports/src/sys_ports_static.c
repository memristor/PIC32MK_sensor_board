...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T8CK, INPUT_PIN_RPA7 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T2CK, INPUT_PIN_RPB15 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T6CK, INPUT_PIN_RPG6 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T7CK, INPUT_PIN_RPC8 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T5CK, INPUT_PIN_RPB10 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T3CK, INPUT_PIN_RPB11 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_T4CK, INPUT_PIN_RPB13 );
